...
| **f32-only enforcement** | **Dot fixed** (f16/bf16 GPU); **legacy binary float32 registry**, **interpretability**, **model_editing**, **unary float32 test path** still hard `dtype.Float32` |
