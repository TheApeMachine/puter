...
func ReferenceLog(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.Log, format)
}
...
func ReferenceSigmoid(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.Sigmoid, format)
}
...
func ReferenceSilu(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.Silu, format)
}
...
func ReferenceCELU(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.CELU, format)
}
...
func ReferenceSoftplus(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.Softplus, format)
}
...
func ReferenceSoftsign(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.Softsign, format)
}
...
func ReferenceHardSigmoid(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.HardSigmoid, format)
}
...
func ReferenceHardSwish(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.HardSwish, format)
}
...
func ReferenceHardTanh(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.HardTanh, format)
}
...
func ReferenceHardGelu(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.HardGelu, format)
}
...
func ReferenceQuickGelu(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.QuickGelu, format)
}
...
func ReferenceTanhShrink(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.TanhShrink, format)
}
...
func ReferenceTanh(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.Tanh, format)
}
...
func ReferenceELU(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.ELU, format)
}
...
func ReferenceSELU(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.SELU, format)
}
...
func ReferenceMish(format dtype.DType) UnaryReference {
	return productionUnaryReference(referenceActivation.Mish, format)
}
