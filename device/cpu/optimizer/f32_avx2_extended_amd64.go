...
//go:noescape
func AdagradStepFloat32AVX2Asm(
...
//go:noescape
func RmspropStepFloat32AVX2Asm(
...
//go:noescape
func HebbianStepRowFloat32AVX2Asm(
	weights, pre, output *float32,
	count int,
	decayFactor, lrPost float32,
)

func adamaxStepSlicesAVX2(
	config AdamaxConfig,
