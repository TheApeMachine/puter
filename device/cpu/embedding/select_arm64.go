...
func runLookupF32Native(
	...
	runLookupF32NEON(table, indices, output, vocab, hidden, indexCount)
}
...
func runBagF32Native(
	...
	runBagF32NEON(table, indices, offsets, output, vocab, hidden, bagCount, indexCount)
}

func runLookupF32NEON(
	table, indices, output unsafe.Pointer,
	vocab, hidden, indexCount int,
) {
