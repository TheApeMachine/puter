...
DATA shapeAllOnesSSE2<>+0(SB)/4, $-1
DATA shapeAllOnesSSE2<>+4(SB)/4, $-1
DATA shapeAllOnesSSE2<>+8(SB)/4, $-1
DATA shapeAllOnesSSE2<>+12(SB)/4, $-1
GLOBL shapeAllOnesSSE2<>(SB), RODATA|NOPTR, $16
...
shape_sse2_where_w4_use:
	...
	VPAND X10, X14, X11
	VPXOR X12, X12, X12
	VPCMPEQD X11, X12, X13
	MOVOU shapeAllOnesSSE2<>(SB), X15
	VPANDN X15, X13, X13
