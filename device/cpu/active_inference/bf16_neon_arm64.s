...
#define BF16_WIDEN_H8_TO_S4_LOW(n, d)  VSHLL_S4_H4_16(n, d)
#define BF16_WIDEN_H8_TO_S4_HIGH(n, d) VSHLL2_S4_H8_16(n, d)
#define BF16_NARROW_S4_TO_H8(lo, hi, dst) \
	VUZP2 V(hi).H8, V(lo).H8, V(dst).H8

#define AI_BF16_BU_ACCUM_S4(src) \
	FCVTL_2D(src, 8) ;\
	FCVTL2_2D(src, 10) ;\
	FADDD F8, F23, F23 ;\
	FADDD F9, F23, F23 ;\
...
#define AI_BF16_FE_HALF \
	BF16_WIDEN_H8_TO_S4_LOW(3, 6) ;\
	BF16_WIDEN_H8_TO_S4_LOW(4, 7) ;\
	BF16_WIDEN_H8_TO_S4_LOW(5, 8) ;\
	VMOV_B16(6, 3) ;\
	VMOV_B16(7, 4) ;\
	VMOV_B16(8, 5) ;\
	AI_BF16_FE_PROCESS4 ;\
	BF16_WIDEN_H8_TO_S4_HIGH(3, 6) ;\
	BF16_WIDEN_H8_TO_S4_HIGH(4, 7) ;\
	BF16_WIDEN_H8_TO_S4_HIGH(5, 8) ;\
	VMOV_B16(6, 3) ;\
	VMOV_B16(7, 4) ;\
	VMOV_B16(8, 5) ;\
	AI_BF16_FE_PROCESS4
...
ai_bf16_pw_loop16:
	...
	BF16_WIDEN_H8_TO_S4_LOW(0, 4)
	BF16_WIDEN_H8_TO_S4_HIGH(0, 5)
	BF16_WIDEN_H8_TO_S4_LOW(1, 6)
	BF16_WIDEN_H8_TO_S4_HIGH(1, 7)
	BF16_WIDEN_H8_TO_S4_LOW(2, 8)
	BF16_WIDEN_H8_TO_S4_HIGH(2, 9)
	BF16_WIDEN_H8_TO_S4_LOW(3, 10)
	BF16_WIDEN_H8_TO_S4_HIGH(3, 11)
	VFMUL_S4(8, 4, 4)
	VFMUL_S4(9, 5, 5)
	VFMUL_S4(10, 6, 6)
	VFMUL_S4(11, 7, 7)
	BF16_NARROW_S4_TO_H8(4, 5, 12)
	BF16_NARROW_S4_TO_H8(6, 7, 13)
...
ai_bf16_bu_loop16:
	...
	VFMUL_S4(10, 6, 6)
	VFMUL_S4(11, 7, 7)
	AI_BF16_BU_ACCUM_S4(4)
	AI_BF16_BU_ACCUM_S4(5)
	AI_BF16_BU_ACCUM_S4(6)
	AI_BF16_BU_ACCUM_S4(7)
	BF16_NARROW_S4_TO_H8(4, 5, 12)
	BF16_NARROW_S4_TO_H8(6, 7, 13)
	VST1.P [V12.H8, V13.H8], 32(R2)
	SUB  $16, R3
