...
TEXT ·GreedySampleFloat32SSE2Asm(SB), NOSPLIT, $0-16
	MOVQ logits+0(FP), SI
	MOVQ SI, BX
	MOVQ count+8(FP), CX
...
greedy_sse2_find_w4:
	...
	PMOVMSKB X3, AX
	TESTQ AX, AX
	JNZ  greedy_sse2_found

	ADDQ $16, SI
	ADDQ $4, R8
	SUBQ $4, CX
	JMP  greedy_sse2_find_w4

greedy_sse2_find_tail:
	TESTQ CX, CX
	JZ   greedy_sse2_fail
